    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="action-title"></h4>
            ...
            <div class="modal-body">
                <div class="alert alert-warning" id="action-body"></div>
                <hr>
                <form action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="" class="form-control" value="2021-03-11 9:43AM">
                        </div>
                    </div>
...
<script>
    ...
    $('#modal-action').on('show.bs.modal', function (e) {
        ...
        $('#action-body').html('You are about to '+title+' <b>PARACETAMOL 500 MG ORALLY ONCE A DAY FOR 14 DAYS.</b>')
    });
