...
<div class="btn-group btn-block border-0 dropleft">
    ...
    <div class="dropdown-menu button-dropdown">
        <!-- <button type="button" class="dropdown-item btn btn-primary" data-toggle="modal" data-target="#ATD-modal"> Add to Doctor </button> -->
        <!-- <a class="dropdown-item" href="<?php echo base_url('nurse/patient-details'); ?>">Patient Details</a> -->
        ...
        <a class="dropdown-item" href="<?php echo base_url('nurse/medication'); ?>">Medication</a>
        <a class="dropdown-item" href="<?php echo base_url('nurse/disposition'); ?>">Disposition</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" data-toggle="modal" data-target="#nurseCancelModal">Cancel ER Visit</a>
    </div>
</div>