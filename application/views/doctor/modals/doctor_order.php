                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade m-3" id="nav-diag-proc" role="tabpanel" aria-labelledby="nav-contact-tab">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-4">
                                <button class="btn btn-sm btn-success" style="width:100%;" data-dismiss="modal" data-toggle="modal" href="#proc-cat">
...
<div class="modal fade" id="proc-cat">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between p-1">
                ...
                <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal" data-toggle="modal" href="#add-doctor-order">Submit</button>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-sm btn-success" data-dismiss="modal">Finalize</button>
            </div>
        </div>
    </div>
</div>
